...
public class DefaultSweetsService implements SweetsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSweetsService.class);
	...
	{
		return DefaultSweetsService.class.getResourceAsStream("/sweets/sap-hybris-platform.png");
	}
