...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSuppliersService.class);
	...
	{
		return DefaultSuppliersService.class.getResourceAsStream("/suppliers/sap-hybris-platform.png");
	}
